...
?>
<div>
    <div style="float: right; font-weight: bold; font-size: 10; font-style: italic; padding-top:3px">SN:<?= $application->certificate_serial ?></div>
    <div style="width:100%;height:100%;margin-top:-0px;margin-left:-10px;margin-bottom:0px;margin-right:-10px;margin:auto;border:solid 4px red;margin-top:5px;">
        ...
        <p style="text-align:center;font-family:'Old English Text MT';color:gray;font-weight:bold;font-size:2.7em;margin-top:-20px;">
            Certificate of Accreditation
        </p>
        <p style="text-align:center;font-family:Arial;color:gray;font-size:1.2em;">
            This is to certify that:
        </p>
        <!--<p><img src="~/favicon.ico" style="margin-top:30%;width:9em;height:4em;" /></p> -->
        
        <p style="text-align:center;font-family:Arial;color:gray;font-weight:100;text-transform:uppercase;text-decoration:underline;font-size:1.5em;"><b>
            <?= $application->company->company_name ?> &nbsp; (<?= $application->company->business_reg_no ?>)</b>
        </p>
        <p style="text-align:center;font-family:Arial;color:gray;font-weight:100;line-height:1.5;font-size:1.4em;">
        ...
        <table style="margin-top: 100px !important;">
            ...
            <td style="width: 120mm; padding-left: 50px;">
                <p style="font-family:Arial;color:gray;font-weight:100;font-size:1.2em; ">
                    <img src="<?= Yii::getAlias('@web'. '/images/francis.jpg'); ?>" style="height:50px" />
            ...
            <td  style="width: auto; text-align:right !important; padding:auto">
                <p style="font-family:Arial;font-weight:100;color:gray;font-size:1.2em; text-align: left">
                 <img src="<?= Yii::getAlias('@web'. '/images/rono1.jpg'); ?>" style="height:50px" />
                    <br/>
                    Kipronoh Ronoh P.<br/>
