        ...
        <div class="row">
            <div class="col-md-6">
                <?= $form->field($model, 'app_company_experience')->widget(Select2::classname(), [
                        'data' => $comp_exp_data,
                        'language' => 'en',
                        'options' => ['placeholder' => 'Select Projects to include with this renewal','multiple'=>true,],
                        'pluginOptions' => [
                            'allowClear' => true, 
            ...
            <div class="col-md-6">
                <?= $form->field($model, 'app_staff')->widget(Select2::classname(), [
                        'data' => $staff_data,
                        'language' => 'en',
                        'options' => ['placeholder' => 'Select Staff to include with this renewal','multiple'=>true,],
                        'pluginOptions' => [
