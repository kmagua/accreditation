...
use app\modules\profesional\models\Application;

/**
 * ApplicationSearch represents the model behind the search form of `app\modules\profesional\models\Application`.
 */
